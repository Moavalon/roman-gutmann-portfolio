...
export const copy = {
  ...
  en: {
    ...
    heroText: "Application developer based in Lower Austria, with foundations in modern web development, experience in AI-assisted project work and more than 20 years of hands-on work with technology, customers and support.",
