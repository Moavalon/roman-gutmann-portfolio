...
export const copy = {
  de: {
    ...
    heroText: "IT-Applikationsentwickler aus Niederösterreich mit praktischer Erfahrung in moderner Webentwicklung, strukturiertem Einsatz von KI in Entwicklungsprojekten und über 20 Jahren Berufspraxis in Technik, Kundenberatung und Support.",
  ...
  en: {
    ...
    heroText: "Application developer based in Lower Austria with practical experience in modern web development, structured use of AI in development projects and more than 20 years of professional experience in technology, customer service and support.",
